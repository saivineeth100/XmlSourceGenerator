    ...
    where TSourceGenerator : IIncrementalGenerator, new()
{
    ...
    public static async Task VerifyGeneratorAsync(string source, DiagnosticResult[] diagnostics, params (string filename, string content)[] generatedSources)
    {
        ...
        // Add necessary references for XmlSourceGenerator
        test.TestState.AdditionalReferences.Add(typeof(IXmlStreamable).Assembly); // XmlSourceGenerator.Abstractions
        test.TestState.AdditionalReferences.Add(typeof(System.Xml.Linq.XElement).Assembly); // System.Xml.Linq
        test.TestState.AdditionalReferences.Add(typeof(System.Xml.Serialization.XmlAttributeAttribute).Assembly); // System.Xml.Serialization
